...
export const quickWorkflow: WorkflowDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      purpose: "Real competitor landscape with pricing, features, and gaps",
      required: ["Existing competitors", "Their pricing", "Their key features", "What they miss"],
    },
    {
      id: "niche-opportunities",
      heading: "Niche Opportunities",
      purpose: "Underserved segments, feature gaps, and edge opportunities",
      required: ["At least 3 niche opportunities", "Evidence for each", "Wedge idea for each"],
    },
    {
      id: "fastest-test",
  ...
  outputRules: [
    ...
    "You MUST analyze existing competitors and their pricing before assessing differentiation",
    "If competitors already exist, your differentiation score must reflect the real gap, not wishful thinking",
    "If the market is saturated, you MUST suggest at least 3 niche opportunities to enter",
    "Every risk must reference real competitor evidence where possible",
